...
export const ARCHIVED: readonly ArchivedEntry[] = [
	...
	},
	{
		...
		note: 'the canonical lineage at change counter 27, which carries the page max_age fix'
	},
	{
		key: 'vendor/static-long64/php8.5-worker.mjs.wasm',
		bytes: 12_234_574,
		sha256: '1a06a07554c136befdce8681777199a67328a906f65cb4f047fd53bbc75b05c9',
		md5: '68b3c2f5e1f996bfddfd4e1ce44586e5',
