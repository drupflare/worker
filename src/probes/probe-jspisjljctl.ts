...
import PHPFactory from '../../vendor/static-jspisjljctl/php8.3-worker.mjs';
import wasmModule from '../../vendor/static-jspisjljctl/php8.3-worker.mjs.wasm';
