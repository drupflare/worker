...
export const SHIPPED_LOCK_VERSIONS: Record<string, string> = {
	...
	'drupal/token': '1.17.0',
	'drupflare/drupflare': 'v0.3.1',
	'drupflare/rom': 'v0.2.2',
